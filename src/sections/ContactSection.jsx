  ...
  const handleSubmit = async (event) => {
    ...
    if (!emailServiceId || !emailTemplateId || !emailPublicKey) {
      setSubmitState({
        status: 'error',
        message:
          'Email service abhi configure nahi hai. `.env` me EmailJS keys add karke dubara try karein.',
      })
      return
    }
    ...
    try {
      ...
      setSubmitState({
        status: 'success',
        message: 'Message successfully send ho gaya. Aapko inbox me mil jana chahiye.',
      })
      ...
      setSubmitState({
        status: 'error',
        message:
          'Message send nahi ho paya. EmailJS template/configuration check karke dubara try karein.',
      })
